...
#Day 9 - Basic Exercises DSA III: Trees, Graphs & Heaps
...
# ---------- minimal Account support (verbatim, needed for BST exercise) ----------
class BankConfig:
    _instance = None
...
def run():
 ...
 7  Create account                   (needed for BST exercise)
 0  Exit
    """
